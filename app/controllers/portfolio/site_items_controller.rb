...
module Portfolio
  class SiteItemsController < ApplicationController
    ...
    def create
      ...
      if @item.save
        redirect_to [@site, @resource_name_p], notice: 'Item project was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @item.update(item_project_params)
        redirect_to [@site, @resource_name_p], notice: 'Item project was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      @item.destroy
      redirect_to [@site, @resource_name_p], notice: 'Item project was successfully destroyed.'
    end
