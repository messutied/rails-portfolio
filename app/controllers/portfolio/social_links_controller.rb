module Portfolio
  class SocialLinksController < ApplicationController
    ...
    def new
      @link = Portfolio::SocialLink.new item: @item
    end
    ...
    def create
      @link = Portfolio::SocialLink.new(link_params)
    ...
    private
      ...
      def set_link
        @link = Portfolio::SocialLink.find(params[:id])
      end

      # Never trust parameters from the scary internet, only allow the white list through.
      def link_params
        params.require(:social_link).permit(:name, :user_name, :item_id)
      end
